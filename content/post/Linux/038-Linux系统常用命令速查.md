...
- [1: 查看系统信息](#1-查看系统信息)
- [2: date 显示系统日期](#2-date-显示系统日期)
- [3: 系统的关机、重启以及登出](#3-系统的关机重启以及登出)
- [4: 文件搜索](#4-文件搜索)
- [5: 挂载一个文件系统](#5-挂载一个文件系统)
- [6: 磁盘空间](#6-磁盘空间)
- [7: 用户和群组](#7-用户和群组)
- [8: 打包和压缩文件](#8-打包和压缩文件)
- [9: linux 包管理器](#9-linux-包管理器)
  - [9.1 RPM 包 - （Fedora, Redhat 及类似系统）](#91-rpm-包---fedora-redhat-及类似系统)
  - [9.2 YUM 软件包升级器 - （Fedora, RedHat 及类似系统）](#92-yum-软件包升级器---fedora-redhat-及类似系统)
  - [9.3 DEB 包 (Debian, Ubuntu 以及类似系统)](#93-deb-包-debian-ubuntu-以及类似系统)
  - [9.4 APT 软件工具 (Debian, Ubuntu 以及类似系统)](#94-apt-软件工具-debian-ubuntu-以及类似系统)
- [10: 查看文件内容](#10-查看文件内容)
- [11: 文本处理](#11-文本处理)
